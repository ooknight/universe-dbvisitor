 ...
 */
package io.github.ooknight.universe.dbvisitor;
...
import io.github.ooknight.universe.dbvisitor.provider.JdbcTemplateProvider;
import io.github.ooknight.universe.dbvisitor.provider.LambdaTemplateProvider;
import io.github.ooknight.universe.dbvisitor.provider.TransactionManagerProvider;
import io.github.ooknight.universe.dbvisitor.provider.TransactionTemplateProvider;
...
import static io.github.ooknight.universe.dbvisitor.ConfigKeys.*;
...
public class DbVisitorModule implements net.hasor.core.Module {
    ...
    private void bindTrans(String dbName, ApiBinder apiBinder, Supplier<DataSource> dsProvider) {
        Supplier<io.github.ooknight.universe.dbvisitor.transaction.TransactionManager> managerProvider = new TransactionManagerProvider(dsProvider);
        Supplier<io.github.ooknight.universe.dbvisitor.transaction.TransactionTemplate> templateProvider = new TransactionTemplateProvider(dsProvider);

        if (StringUtils.isBlank(dbName)) {
            apiBinder.bindType(io.github.ooknight.universe.dbvisitor.transaction.TransactionManager.class).toProvider(managerProvider);
            apiBinder.bindType(io.github.ooknight.universe.dbvisitor.transaction.TransactionTemplate.class).toProvider(templateProvider);
        } else {
            apiBinder.bindType(io.github.ooknight.universe.dbvisitor.transaction.TransactionManager.class).nameWith(dbName).toProvider(managerProvider);
            apiBinder.bindType(io.github.ooknight.universe.dbvisitor.transaction.TransactionTemplate.class).nameWith(dbName).toProvider(templateProvider);
        }

        TranInterceptor tranInter = new TranInterceptor(dsProvider);
        apiBinder.bindInterceptor(new ClassAnnotationOf(io.github.ooknight.universe.dbvisitor.transaction.Transactional.class), new MethodAnnotationOf(io.github.ooknight.universe.dbvisitor.transaction.Transactional.class), tranInter);
    }
