...
import io.github.ooknight.universe.dbvisitor.spring.annotation.MapperScan;
    ...
    public void afterPropertiesSet() throws Exception {
        ...
        if (this.session == null) {
            if (StringUtils.isNotBlank(this.sessionRef)) {
                logger.debug("load MapperFile to Session '" + this.sessionRef + "'");
                this.session = (Session) this.applicationContext.getBean(this.sessionRef);
            } else {
                logger.debug("load MapperFile to default Session.");
