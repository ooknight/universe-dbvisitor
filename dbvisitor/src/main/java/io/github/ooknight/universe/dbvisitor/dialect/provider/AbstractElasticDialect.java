...
public abstract class AbstractElasticDialect extends AbstractBuilderDialect implements PageSqlDialect {
    ...
    @Override
    public BoundSql buildSelect(boolean useQualifier) {
    ...
    @Override
    public BoundSql buildInsert(boolean useQualifier, List<String> primaryKey, DuplicateKeyStrategy duplicateKeyStrategy) {
        StringBuilder json = new StringBuilder();
        json.append("{");
    ...
    @Override
    public BoundSql buildUpdate(boolean useQualifier, boolean useReplace) {
        StringBuilder json = new StringBuilder();
        json.append("{");
    ...
    @Override
    public BoundSql buildDelete(boolean useQualifier, boolean useReplace) {
        StringBuilder json = new StringBuilder();
        json.append("{");
