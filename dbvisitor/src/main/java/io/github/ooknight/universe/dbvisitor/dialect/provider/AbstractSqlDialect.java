 ...
 */
package io.github.ooknight.universe.dbvisitor.dialect.provider;
import java.util.*;
...
import io.github.ooknight.universe.dbvisitor.dialect.features.InsertSqlDialect;
import io.github.ooknight.universe.dbvisitor.lambda.DuplicateKeyStrategy;
import io.github.ooknight.universe.dbvisitor.lambda.core.OrderNullsStrategy;
import io.github.ooknight.universe.dbvisitor.lambda.core.OrderType;
import io.github.ooknight.universe.dbvisitor.lambda.segment.MergeSqlSegment;
import io.github.ooknight.universe.dbvisitor.lambda.segment.Segment;
...
public abstract class AbstractSqlDialect extends AbstractBuilderDialect {
    ...
    @Override
    public BoundSql buildSelect(boolean delimited) {
        this.args.clear();
    ...
    @Override
    public BoundSql buildUpdate(boolean delimited, boolean allowEmptyWhere) {
        this.args.clear();
        MergeSqlSegment s = new MergeSqlSegment();
    ...
    @Override
    public BoundSql buildDelete(boolean delimited, boolean allowEmptyWhere) {
        this.args.clear();
        MergeSqlSegment s = new MergeSqlSegment();
    ...
    @Override
    public BoundSql buildInsert(boolean delimited, List<String> primaryKey, DuplicateKeyStrategy strategy) {
        this.args.clear();
        MergeSqlSegment s = new MergeSqlSegment();
