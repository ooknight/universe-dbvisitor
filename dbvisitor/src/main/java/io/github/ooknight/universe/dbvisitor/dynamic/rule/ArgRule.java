...
import io.github.ooknight.universe.dbvisitor.dynamic.*;
...
public class ArgRule implements SqlRule {
    ...
    /** 执行参数规则 */
    public void executeRule(SqlArgSource data, QueryContext context, SqlBuilder sqlBuilder, String expr, Map<String, String> config) {
    ...
    private TypeHandler<?> createTypeHandler(QueryContext context, Class<?> javaType, String handlerType, Object argValue) {
        ...
        try {
            ...
            throw new RuntimeSQLException("handlerType '" + handlerType + "' ClassNotFoundException.");
        }
