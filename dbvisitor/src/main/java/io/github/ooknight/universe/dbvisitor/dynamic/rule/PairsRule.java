...
import io.github.ooknight.universe.dbvisitor.dynamic.args.StackSqlArgSource;
...
public class PairsRule implements SqlRule {
    ...
    public void executeRule(SqlArgSource data, QueryContext context, SqlBuilder sqlBuilder, String activeExpr, String ruleValue) {
        ...
        if (args.length != 1) {
            throw new RuntimeSQLException("role PAIRS args error, require 1, but " + args.length);
        }
        ...
        if (argValue instanceof java.util.Map) {
            ...
            throw new RuntimeSQLException("role PAIRS require Map type parameter, but " + argValue.getClass().getName());
        }
    }

    private void buildPair(SqlBuilder sqlBuilder, PlanDynamicSql pairTemplate, SqlArgSource data, QueryContext context, Object k, Object v, int i) {
