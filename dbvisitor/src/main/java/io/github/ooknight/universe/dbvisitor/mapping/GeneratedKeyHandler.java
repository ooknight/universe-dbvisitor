...
public interface GeneratedKeyHandler {
     ...
     * @return 生成的主键值
     */
    default Object beforeApply(Connection conn, Object entity, ColumnMapping mapping) {
        return null;
    }
     ...
     * @return 获取到的主键值
     */
    default Object afterApply(ResultSet generatedKeys, Object entity, int argsIndex, ColumnMapping mapping) {
        return null;
    }
}
