...
public class WhenRule extends AbstractCaseRule {
    ...
    public void executeRule(SqlArgSource data, QueryContext context, SqlBuilder sqlBuilder, String activeExpr, String ruleValue) {
        ...
        if (!data.hasValue(CURRENT_CASE_ID_KEY) || caseId == null) {
            throw new RuntimeSQLException("The '" + (isElse ? "else" : "when") + "' rule must be used within the 'case' rule.");
        }
    ...
    private void executeElse(SqlArgSource data, QueryContext context, SqlBuilder sqlBuilder, String activeExpr, String ruleValue, String caseId) {
    ...
    private void executeWhen(SqlArgSource data, QueryContext context, SqlBuilder sqlBuilder, String activeExpr, String ruleValue, String caseId) {
        boolean isMatch;
